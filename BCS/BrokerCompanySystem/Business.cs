...
{
    internal class Business : Building
    {
        ...
        public string BussinessName
        {
            ...
            set
            {
                if (value.EndsWith(" Business")) bussinessName = value;
                else throw new ArgumentException("Name of business buildings should end on Business!");
            }
        }

        public Business(string name, string city, int stars, double rentAmmount) : base(name, city, stars, rentAmmount)
        {
            Name = name;
            City = city;
            Stars = stars;
